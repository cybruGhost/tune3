...
public final class ItemWelcomeBinding implements ViewBinding {
  ...
  private ItemWelcomeBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivIcon,
  ...
  public static ItemWelcomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemWelcomeBinding((ConstraintLayout) rootView, ivIcon, tvDescription, tvTitle);
    }
